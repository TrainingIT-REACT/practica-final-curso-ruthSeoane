              ...
              <div className="App container">
                <div className="navBar">
                  ...
                  <NavLink activeClassName="active" to="/mi_musica" className="elemento">Mi m&uacute;sica</NavLink>
                    ...
                    <div className="dropdown elemento perfil" id = "botonOrigen">
                      <div>
                  ...
                  {/* Le añado al elemento un onClick y creo una funcion que pille un elemento por id y le ponga la clase activa */}

                    </div>
                      <div className="dropdown-content">
                        <NavLink to="/perfil">Ver perfil</NavLink>
                        {/* <NavLink to="/perfil">Login</NavLink> */}
                      </div>
                    </div> 
                </div>
